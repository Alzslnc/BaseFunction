...
namespace BaseFunction
{
    ...
    public class SpEntity : IDisposable
    {
        ...
        public Point3d Center
        {
            ...
            set
            {
                if (Circle != null && !Circle.Center.IsEqualTo(value))
                {
                    Circle.Center = value;
        ...
        public Point3d StartPoint
        {
            ...
            set
            {
                if (Curve != null && !Curve.StartPoint.IsEqualTo(value))
                {
                    Curve.StartPoint = value;
                    OnChange(this, EventArgs.Empty);
                }
            }
        }
        public Point3d EndPoint
        {
            ...
            set
            {
                if (Curve != null && !Curve.EndPoint.IsEqualTo(value))
                {
        ...
        public double Radius
        {
            ...
            set
            {
                if (Circle != null && !Circle.Radius.IsEqualTo(value))
                {
                    try
                    {
                        Circle.Radius = value;
